...
function catchData(array) {
    ...
    var became = sessionStorage.setItem('preguntatest2', JSON.stringify(arrayOrder));
    console.log(became);
    ...
    checkbox1 = document.getElementById('check1test2')
...
checkbox2 = document.getElementById('check2test2')
...
checkbox3 = document.getElementById('check3test2')
