...
function catchData(array) {
    ...
    var became = sessionStorage.setItem('preguntatest', JSON.stringify(arrayOrder));
    console.log(became);
    ...
    checkbox1 = document.getElementById('check1test')
...
checkbox2 = document.getElementById('check2test')
...
checkbox3 = document.getElementById('check3test')
